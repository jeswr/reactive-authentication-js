 ...
 * assertion to {@link tokenEndpoint}, and returns a DPoP-bound token (the
 * binding to the resource request is performed by {@link DPoPTokenProvider}).
 */
...
/**
 * The redirect-free WebAuthn {@link TokenExchange} (`spec/ARCHITECTURE.md` §6.2):
 *
 ...
 * {@link DPoPTokenProvider}; this exchange only attaches the shared DPoP handle
 * to the RFC 8693 grant and asserts the issued token is sender-constrained.
 */
